...
import { instrumentSamples } from '../music/sampleLibrary';

function MusicPlayer({ activeHouse, musicPlan }) {
  ...
  const getSynthForInstrument = (instrument) => {
    switch (instrument) {
      ...
      case 'bassoon':
        return new Tone.Synth({
          oscillator: { type: 'triangle' },
          envelope: { attack: 0.3, decay: 0.4, sustain: 0.3, release: 1.4 }
        });
      default:
        return new Tone.Synth();
    }
    ...
    <div className="music-player">
      ...
      <div className="volume-control">
        ...
        <input
          ...
          step={0.01}
          defaultValue={1}
          onChange={(e) => masterGain.current.gain.rampTo(parseFloat(e.target.value), 0.1)}
        />
      </div>
